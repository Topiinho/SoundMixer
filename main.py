...
#   ==================== - APPS - ====================
    ...
    def set_app_volume(self, app_name: str, volume_level: float) -> None:
        try:
            ...
            logger.error(f"Erro inesperado ao definir volume para {app_name}: {e}")
...
#   ==================== - Devices - ====================
    ...
    def set_output_device(self, device_id: str) -> None:
        try:
            ...
            logger.info(f"Dispositivo de saída alterado: {device_id}")
        except Exception as e:
            logger.error(f"Erro inesperado ao alterar dispositivo de saída: {e}")
    ...
    def set_input_device(self, device_id: str) -> None:
        try:
            ...
            logger.info(f"Dispositivo de entrada alterado: {device_id}")
        except Exception as e:
            logger.error(f"Erro inesperado ao alterar dispositivo de entrada: {e}")
